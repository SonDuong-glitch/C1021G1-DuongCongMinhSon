...
public class UserDAO implements IUserDAO{
    ...
    @Override
    public List<User> sortByName( String lenh ) throws SQLException {

        List<User> users = new ArrayList<>();

        try (Connection connection = getConnection(); PreparedStatement statement = connection.prepareStatement(SORT_USER_BY_NAME_SQL+ " "+ lenh);) {
