package com.example.borrow_books.reponsitory.impl;
...
public class CustomerReponsitory implements ICustomerRepository {
    @Autowired
    ICustomerRepository customerRepository;

    @Override
    public Customer findByNameCustomer(String customerName) {
        return null;
    }
